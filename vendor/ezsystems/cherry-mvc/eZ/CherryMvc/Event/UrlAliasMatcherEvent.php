...
namespace eZ\CherryMvc\Event;

use eZ\CherryMvc\Routing\Matcher\UrlAliasMatcherInterface;
...
{
    /**
     * @var \eZ\CherryMvc\Routing\Matcher\UrlAliasMatcherInterface
     */
    private $urlAliasMatcher;

    /**
     * @return \eZ\CherryMvc\Routing\Matcher\UrlAliasMatcherInterface
     */
     ...
     * @param \eZ\CherryMvc\Routing\Matcher\UrlAliasMatcherInterface $urlAliasMatcher
     */
